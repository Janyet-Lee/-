<template>
  <div id="detail">
	...
	<router-link tag="div" to="/sessions/historydetail/specialdetail" class="special-list" v-for="item in items">
	    <div class="special-ditail">
		    ...
		    <div class="special-details">
			    <div class="special-item-line">
				    <div class="session-state-left">{{item.state3}}</div>
			    </div>
    			...
    			<div class="sit-address">{{item.address}}</div>
    	        </div>
		    </div>
...
export default {
  ...
  mounted () {
    this.$http.get('../../../../static/data/detail.json').then(function(response){
